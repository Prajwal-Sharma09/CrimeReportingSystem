...
<body>
    ...
    $q = "SELECT user_id, user_name, address, phone_no, age, gender, email,  citizenship_no, image from user where status = '0'";
...
<tr class="text-center">
        ...
        <td> <button class="btn btn-danger"> <a href="user_history_delete.php?user_id=<?php echo $res['user_id']; ?>" class="text-white"> Delete </a> </button> </td>

        <td> <button class="btn btn-secondary"> <a href="user_history_restore.php?user_id=<?php echo $res['user_id']; ?>" class="text-white"> Restore </a> </button> </td>
