...
?>
        ...
        <td> <button class="btn btn-danger"> <a href="complaint_delete.php?complain_id=<?php echo $res['complain_id']; ?>" class="text-white"> Delete </a> </button> </td>
        
        <td> <button class="btn btn-secondary"> <a href="complaint_update.php?complain_id=<?php echo $res['complain_id']; ?>" class="text-white"> Update </a> </button> </td>
      </tr>
