...
<body>
	...
	<div class="main-container">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="row">
						<table class="data-table stripe hover nowrap">
							<thead>
								<tr>
									<th class="table-plus datatable-nosort">Complaint Id</th>
									<th> User ID </th>
							        <th> User Name </th>
							        <th> Delete </th>	
								</tr>
      ...
      <tr class="text-center">
        ...
        <td> <button class="btn btn-danger"> <a href="user_complaint_delete.php?complain_id=<?php echo $res['complain_id']; ?>" class="text-white"> Delete </a> </button> </td>
